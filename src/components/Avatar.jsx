...
const facialExpressions = {
  ...
  surprised: {
    browInnerUp: 0.5,
    eyeWideLeft: 0.5,
    eyeWideRight: 0.499001660944492,
    jawOpen: 0.4,
    mouthFunnel: 0.31,
  },
  angry: {
...
export function Avatar(props) {
  ...
  useMemo(() => {
    angryAnimation.animations[0].name = "Angry";
    cryingAnimation.animations[0].name = "Crying";
    laughingAnimation.animations[0].name = "Laughing";
    rumbaDancingAnimation.animations[0].name = "Rumba";
    standingIdleAnimation.animations[0].name = "Standing Idle";
    talkingAnimation.animations[0].name = "Talking";
    terrifiedAnimation.animations[0].name = "Terrified";
  }, [
    angryAnimation,
    cryingAnimation,
    laughingAnimation,
    rumbaDancingAnimation,
    standingIdleAnimation,
    talkingAnimation,
    terrifiedAnimation,
  ]);
  ...
  const animations = useMemo(
    () => [
      ...angryAnimation.animations,
      ...cryingAnimation.animations,
      ...laughingAnimation.animations,
      ...rumbaDancingAnimation.animations,
      ...standingIdleAnimation.animations,
      ...talkingAnimation.animations,
      ...terrifiedAnimation.animations,
    ],
    [
      angryAnimation,
      cryingAnimation,
